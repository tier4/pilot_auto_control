...
| `awf-launch-latest` | `autowarefoundation/autoware_launch:main`, `autoware_control_config`, `autoware_control_launch` |
...
`main`). Launch stays on `awf-launch-latest`; everything else at the root
